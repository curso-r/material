...
O materiais dessa página ajuda a usar o R na execução de tarefas
...
sua vez é baseado no [`tidyverse`](http://tidyverse.org/), ou *universo arrumado*,
...
Você precisará instalar os seguintes softwares/pacotes:
